...
export default function SplashPage() {
  return (
    <main className="min-h-screen bg-[#0a0b0e] flex flex-col items-center justify-center relative overflow-hidden">
      {/* Ambient glow orbs */}
      <div className="glow-orb glow-orb-primary glass-pulse absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[42rem] h-[42rem] rounded-full blur-[120px] pointer-events-none" />
      <div className="glow-orb glow-orb-primary glass-pulse absolute left-1/2 top-[42%] -translate-x-1/2 -translate-y-1/2 w-[22rem] h-[22rem] rounded-full blur-[80px] pointer-events-none" style={{ animationDelay: "1s" }} />
      ...
      <div className="relative z-10 flex flex-col items-center space-y-8 px-6">
        ...
        <div className="text-center">
          <div className="relative inline-block glass-float">
        ...
        <div className="flex flex-col items-center space-y-4 mt-4">
          <Link
            ...
            className="glass-btn-primary px-12 py-4 text-white font-headline font-bold hover:scale-105 active:scale-95 transition-all duration-200 text-sm uppercase tracking-widest"
          >
            Enter the Void
          </Link>
          <span className="glass-badge inline-flex items-center gap-2 px-3 py-1 text-[10px] font-mono uppercase tracking-[0.2em] text-teal-200/80">
